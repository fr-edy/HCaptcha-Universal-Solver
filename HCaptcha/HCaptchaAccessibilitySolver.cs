...
public class HCaptchaAccessibilitySolver
{
    private string hc_accessibility;

    public HCaptchaAccessibilitySolver(string hc_accessibility)
    {
        this.hc_accessibility = hc_accessibility;
    }

    public string Solve(string sitekey, string host, string page, string widgetId, string siteOrigin, string siteReferer, string version, HCaptchaMovementsIntensity movementsIntensity, HCatpchaProxy proxy = null)
    {
            ...
            {
                {
                    ...
                    var request = (HttpWebRequest)WebRequest.Create("https://newassets.hcaptcha.com/captcha/v1/" + version + "/static/hcaptcha-challenge.html");
                ...
                {
                    ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
                    var request = (HttpWebRequest)WebRequest.Create("https://newassets.hcaptcha.com/captcha/v1/" + version + "/static/i18n/it.json");
                ...
                {
                    ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
                    var request = (HttpWebRequest)WebRequest.Create("https://newassets.hcaptcha.com/captcha/v1/" + version + "/static/hcaptcha-checkbox.html");
                ...
                {
                    ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
                    var request = (HttpWebRequest)WebRequest.Create("https://newassets.hcaptcha.com/captcha/v1/" + version + "/hcaptcha-checkbox.js");
                ...
                {
                    ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
                    var request = (HttpWebRequest)WebRequest.Create("https://newassets.hcaptcha.com/captcha/v1/" + version + "/hcaptcha-challenge.js");
                ...
                {
                    ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
                    var request = (HttpWebRequest)WebRequest.Create("https://hcaptcha.com/checksiteconfig?v=" + version + "&host=" + host + "&sitekey=" + sitekey + "&sc=1&swa=1");
                ...
                {
                    ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
                    var request = (HttpWebRequest)WebRequest.Create("https://newassets.hcaptcha.com/c/9449fda8/hsw.js");
                ...
                {
                    ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
                    var request = (HttpWebRequest)WebRequest.Create("https://hcaptcha.com/getcaptcha?s=" + sitekey);
